.PHONY: help quality api-smoke-local ui-smoke-local hybrid-smoke-local docker-build api-smoke ui-smoke hybrid-smoke smoke-all docker-down ci-local
...
help:
	...
	@echo "  hybrid-smoke-local - Run Hybrid API→UI smoke locally"
	...
	@echo "  hybrid-smoke - Run Hybrid smoke in Docker (with Selenium)"
...
hybrid-smoke-local:
	mvn -B -pl hybrid-tests -am clean test -Psmoke-hybrid
...
docker-down:
	docker compose --profile ui --profile hybrid down -v
